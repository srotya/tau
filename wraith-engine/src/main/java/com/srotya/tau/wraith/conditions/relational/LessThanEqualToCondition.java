 ...
 * is less than equal to the specified value
 * 
 * @author ambud_sharma
 */
public class LessThanEqualToCondition extends NumericCondition {

	private static final long serialVersionUID = 1L;

	public LessThanEqualToCondition(String header, double value) {
		super(header, value);
	}
